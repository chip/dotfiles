require "paq" {
    ...
    "neovim/nvim-lspconfig", "hrsh7th/cmp-nvim-lsp", -- autocompletion with nvim-cmp
    "hrsh7th/cmp-buffer", "hrsh7th/cmp-path", "hrsh7th/cmp-cmdline",
    "hrsh7th/nvim-cmp", "hrsh7th/cmp-vsnip", -- For vsnip users.
    "hrsh7th/vim-vsnip", "williamboman/nvim-lsp-installer",
    ...
    "onsails/lspkind-nvim", "numToStr/Comment.nvim", -- For code comments
    "Olical/conjure", "tpope/vim-dispatch", "clojure-vim/vim-jack-in",
    "radenling/vim-dispatch-neovim", "bhurlow/vim-parinfer", -- Parenthesis mgt for Clojure and other LISP"s
    ...
    "williamboman/nvim-lsp-installer", "szw/vim-maximizer",
    "nvim-telescope/telescope-github.nvim", "hkupty/impromptu.nvim",
    "lewis6991/impatient.nvim", "ckipp01/stylua-nvim"
}
